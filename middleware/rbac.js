...
const ROLE_ALIASES = {
    ...
    'PURCHASING_OFFICER': ROLES.PURCHASING,
    'PURCHASING_DEPARTMENT': ROLES.PURCHASING,
    'PURCHASING_MANAGER': ROLES.PURCHASING,
    'CHIEF_EXECUTIVE_OFFICER': ROLES.CEO,
    'EXECUTIVE': ROLES.CEO,
    'CHIEF_EXECUTIVE': ROLES.CEO,
    'QC_INSPECTOR': ROLES.QC,
    'QUALITY_CONTROL': ROLES.QC,
    'QUALITY_CONTROL_INSPECTOR': ROLES.QC,
    'QC_OFFICER': ROLES.QC,
...
const PERMISSIONS = {
    // Client Management
    'clients:view': [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ACCOUNTING, ROLES.CEO],
    ...
    'users:view': [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.CEO],
    'users:create': [ROLES.SUPER_ADMIN, ROLES.ADMIN],
    'users:update': [ROLES.SUPER_ADMIN, ROLES.ADMIN],
    'users:delete': [ROLES.SUPER_ADMIN],

    // Product Master Data
    'products:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.QC, ROLES.PURCHASING, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.ACCOUNTING, ROLES.INVENTORY, ROLES.CLIENT],
    ...
    'supply_requests:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.PURCHASING, ROLES.INVENTORY],
    'supply_requests:manage': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PURCHASING],
    ...
    // Job Orders (JO)
    'job_orders:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.QC, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.CLIENT],
    ...
    'production:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.QC, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.CLIENT],
    'production:create_batch': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PRODUCTION],
    'production:log_yield': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PRODUCTION, ROLES.QC],
    'production:approve_overrun': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN],

    // Deliveries & DRs
    'deliveries:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.QC, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.ACCOUNTING, ROLES.CLIENT],
    'deliveries:create': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.WAREHOUSE, ROLES.PRODUCTION],
    'deliveries:update': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.WAREHOUSE, ROLES.PRODUCTION],
    ...
    // Invoices & Billing
    'invoices:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.ACCOUNTING, ROLES.CLIENT],
    ...
    'payments:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.ACCOUNTING, ROLES.CLIENT],
    'payments:create': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.ACCOUNTING],

    // Buffer Stock Management
    'buffer_stock:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.WAREHOUSE, ROLES.ACCOUNTING, ROLES.CLIENT],
    'buffer_stock:release': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.WAREHOUSE, ROLES.ACCOUNTING],

    // Reports & Analytics
    'reports:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.ACCOUNTING, ROLES.CLIENT],
    'reports:financial': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.ACCOUNTING],
    'reports:production': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO, ROLES.QC, ROLES.PRODUCTION],

    // Audit Logs
    'audit_logs:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.CEO]
};
...
function roleHasPermission(role, permissionName) {
    ...
    if (norm === ROLES.CEO && (permissionName.endsWith(':view') || permissionName.startsWith('reports:') || permissionName === 'audit_logs:view')) return true; // CEO has universal read-only oversight across all operations
