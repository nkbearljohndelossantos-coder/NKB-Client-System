...
const PERMISSIONS = {
    ...
    // Product Master Data
    'products:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PURCHASING, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.ACCOUNTING, ROLES.INVENTORY, ROLES.CLIENT],
    ...
    'orders:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PURCHASING, ROLES.PRODUCTION, ROLES.WAREHOUSE, ROLES.ACCOUNTING, ROLES.INVENTORY, ROLES.CLIENT],
    ...
    'supply_requests:view': [ROLES.SUPER_ADMIN, ROLES.IT_ADMIN, ROLES.ADMIN, ROLES.PURCHASING, ROLES.INVENTORY],
